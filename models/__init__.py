...
@torch.no_grad()
def dpmpp_sampler(x_mod, scorenet, x0=None, cond=None, just_beta=False, final_only=False, denoise=True, subsample_steps=None,
                 same_noise=False, noise_val=None, frac_steps=None, verbose=False, log=False, clip_before=True, 
                 t_min=-1, gamma=False, **kwargs):
    ...
    x_mod = dpm_solver.sample(
        x_mod,
        steps=subsample_steps,
        order=3,
