...
class UNetMore_DDPM(nn.Module):
  def __init__(self, config):
    ...
    assert self.version == "DDPM" or self.version == "DDIM" or self.version == "FPNDM" or self.version == "DPMPP", f"models/unet : version is not DDPM or DDIM! Given: {self.version}"
