...
def favor_attention(query,
  ...
  av_attention2 = av_attention.permute(1, 2, 3, 0)
  # print(av_attention2.shape)
  # exit(0)
  ...
  attention_map = av_attention / attention_normalizer
...
class Attention(nn.Module):
  ...
  def forward(self,
    ...
    # print(query.shape,query_input.shape)
    # print(key.shape,source_input.shape)
