...
export exp="../output/ijcai23/bair64_big192_5c1_prevfutpmask50_spynet_cross2"
...
# export exp="../output/ijcai23/bair64_big192_5c1_pmask50_cross"
...
cp ${exp}/code/models/better/fast_attention.py models/better/fast_attention.py
...
# cp models/better/fast_attention.py ${exp}/code/models/better/fast_attention.py
...
CUDA_VISIBLE_DEVICES=4 python main.py --test_speed --config configs/${config}.yml --data_path ${data} --exp ${exp} --ni --config_mod ${config_mod}
