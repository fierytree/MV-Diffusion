...
# export config_mod="model.ngf=192 model.n_head_channels=192 data.prob_mask_cond=0 data.prob_mask_future=0 data.num_frames=5 data.num_frames_cond=2 data.num_frames_future=2 training.batch_size=64 sampling.batch_size=100 sampling.max_data_iter=1000 model.arch=unetmore"
